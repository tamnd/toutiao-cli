// Package cli builds the toutiao command tree on top of the toutiao library.
package cli
...
func Root() *cobra.Command {
	app := &App{cfg: toutiao.DefaultConfig()}
...
func (a *App) setup() error {
	...
	a.client = toutiao.NewClient(a.cfg)
	return nil
}
